...
function send_notification ()
{
  ...
  echo "Telegram information set, sending $1 message" && \
  curl --silent -XPOST -d "chat_id=$TELEGRAMCHATID" -d "text=$MESSAGETEXT" "https://api.telegram.org/bot$TELEGRAMBOTTOKEN/sendMessage"
}
